...
public class DatePickerMenuPage extends WidgetsPage{
    ...
    private By dayValue(String day){
        return By.xpath("//div[contains(@class,'datepicker__day react-datepicker__day--')][text() = '"+day+"']");

    }

    public void clickDay(String day){
//       By dayValue = By.xpath("//div[contains(@class,'datepicker__day react-datepicker__day--')][text() = '"+day+"']");
//       click(dayValue);
       click(dayValue(day));
    }
